...
TreeNode* buildTree() {
	...
	// 1. ask your friend to build the leftSubtree using the preOrder traversal of the leftSubtree
	root->left = buildTree();

	// 2. ask your friend to build the rightSubtree using the preOrder traversal of the rightSubtree
