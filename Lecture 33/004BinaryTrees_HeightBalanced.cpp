...
Pair checkHeightBalancedEfficient(TreeNode* root) {
	...
	// 1. recursively, check if the leftSubtree is heightBalanced and compute the height of the leftSubtree
	Pair left = checkHeightBalancedEfficient(root->left);

	// 2. recursively, check if the rightSubtree is heightBalanced and compute the height of the rightSubtree
